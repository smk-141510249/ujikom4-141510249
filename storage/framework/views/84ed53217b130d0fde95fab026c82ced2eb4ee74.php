...
<html lang="en">
	...
	<script src="<?php echo e(url('point/js/jquery.js')); ?>"></script>
	<script src="<?php echo e(url('point/js/jquery-migrate-1.2.1.js')); ?>"></script>
	<script src="<?php echo e(url('point/js/camera.js')); ?>"></script>
	<script src="<?php echo e(url('point/js/touchTouch.jquery.js')); ?>"></script>
	<script src="<?php echo e(url('point/js/jquery.stellar.js')); ?>"></script>
	<script src="<?php echo e(url('point/js/script.js')); ?>"></script>
