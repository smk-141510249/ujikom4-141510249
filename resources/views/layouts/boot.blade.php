...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="{{url('Day/css/bootstrap.min.css" rel="stylesheet')}}">
	<link rel="{{url('Day/stylesheet" href="css/font-awesome.min.css')}}">
	<link rel="{{url('Day/stylesheet" href="css/animate.css')">
	<link href="{{url('Day/css/animate.min.css" rel="stylesheet')}}"> 
	<link href="{{url('Day/css/style.css" rel="stylesheet')}}" />	
    <!-- =======================================================
        Theme Name: Day
